        ...
        <div class="col-xl-12 mb-5 mb-xl-0">
            <div class="card">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a href="#">
                                                <i class="far fa-check-circle"></i> เมนูสำหรับหัวหน้าฝ่าย
                                            </a>
                                        </li>
                                        <li class="breadcrumb-item active" aria-current="page">ระบบอนุมัติวันลา</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <table id="leave_list" class="display responsive nowrap" style="width:100%;">
                        <thead>
                            <tr>
